  ...
  const services = [
    {
      ...
      description: 'Contrôle obligatoire tous les 2 ans pour les véhicules de plus de 4 ans',
      price: '70€',
      duration: '30 min',
    },
    {
      title: 'Contre-Visite',
      description: 'Vérification des réparations effectuées suite à un contrôle défavorable',
      price: '25€',
      duration: '15 min',
    },
    {
      ...
      <section className="services-list">
        {services.map((service, index) => (
          <div key={index} className="service-card">
            ...
            <a href="/rendez-vous" className="book-button">Réserver</a>
          </div>
        ))}
      </section>
      ...
      <section className="process">
        ...
        <div className="process-steps">
          <div className="step">
            ...
            <h3>Accueil</h3>
            <p>Présentation de vos documents et vérification de votre identité</p>
          </div>
          <div className="step">
            <div className="step-number">2</div>
            <h3>Contrôle</h3>
            <p>Inspection complète de votre véhicule par nos techniciens certifiés</p>
          </div>
          <div className="step">
