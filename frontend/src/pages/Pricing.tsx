      ...
      <section className="pricing-content">
        <div className="pricing-table">
          <div className="pricing-card featured">
            ...
            <a href="/rendez-vous" className="cta-button">Réserver</a>
          </div>
        ...
        <div className="faq">
          ...
          <div className="faq-item">
            ...
            <p>Le premier contrôle technique est obligatoire dans les 6 mois avant le 4ème anniversaire de votre véhicule, puis tous les 2 ans.</p>
          </div>
          <div className="faq-item">
          ...
          <div className="faq-item">
            ...
            <p>Vous avez 2 mois pour faire effectuer les réparations nécessaires et revenir pour la contre-visite.</p>
          </div>
        </div>
      </section>
    </div>
